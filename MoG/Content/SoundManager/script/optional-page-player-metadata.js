...
var Metadata = function(oSound) {
  ...
  for (i=0; i<oItems.length; i++) {
    this.data[i] = {
      o: null,
      title: oItems[i].getElementsByTagName('span')[0].innerHTML,
      startTime: oItems[i].getElementsByTagName('span')[1].innerHTML,
      startSeconds: self.strToTime(oItems[i].getElementsByTagName('span')[1].innerHTML.replace(/[()]/g,'')),
      duration: 0,
      durationMS: null,
      startTimeMS: null,
      endTimeMS: null,
